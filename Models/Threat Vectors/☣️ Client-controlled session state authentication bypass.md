...
# ☣️ Client-controlled session state authentication bypass
...
`🔑 UUID : 38adba1e-0961-4417-bd84-33fa9c42439f` **|** `🏷️ Version : 1` **|** `🗓️ Creation Date : 2026-05-04` **|** `🗓️ Last Modification : 2026-05-04` **|** `Sharing Organisation : {'uuid': '56b0a0f0-b0bc-47d9-bb46-02f80ae2065a', 'name': 'EC DIGIT CSOC'}` **|** `🧱 Schema Identifier : tvm::2.1`
...
mindmap
Root[☣️ Client-controlled session state authentication bypass]
    
      🎯 Detect clientcontrolled session state authentication bypass 
...
|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------|:---------------------|
| [Detect client-controlled session state authentication bypass](../Detection%20Objectives/🎯%20Detect%20client-controlled%20session%20state%20authentication%20bypass.md 'Detect or continuously validate web applications that grant authentication or authorisation based on client-suppliedcookies, Authorization headers, or...') | [Detect client-controlled session state authentication bypass::Repeated enumeration of session variable names](Detect%20client-controlled%20session%20state%20authentication%20bypass#repeated-enumeration-of-session-variable-names.md 'Detect repeated attempts from the same source to discover accepted session variables by tryingmany cookie or header names and simple values This inclu...')<br>[Detect client-controlled session state authentication bypass::Protected resource access after fabricated session value](Detect%20client-controlled%20session%20state%20authentication%20bypass#protected-resource-access-after-fabricated-session-value.md 'Detect HTTP requests to protected endpoints where access is denied with no session state butsucceeds when the client supplies fabricated or generic st...')<br>[Detect client-controlled session state authentication bypass::Privilege shift after cookie or header modification](Detect%20client-controlled%20session%20state%20authentication%20bypass#privilege-shift-after-cookie-or-header-modification.md 'Detect cases where changing a client-controlled identity, username, role, or feature flag valueresults in a higher-privilege response Examples include...') | ❌ No Detection Models  | ❌ No Detection Rules |
...
- [_5_] https://cwe.mitre.org/data/definitions/602.html
...
[5]: https://cwe.mitre.org/data/definitions/602.html
