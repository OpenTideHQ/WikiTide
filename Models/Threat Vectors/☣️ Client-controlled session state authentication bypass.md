...
`🔑 UUID : 38adba1e-0961-4417-bd84-33fa9c42439f` **|** `🏷️ Version : 2` **|** `🗓️ Creation Date : 2026-05-04` **|** `🗓️ Last Modification : 2026-05-04` **|** `👥 Contributors : Hold Security Threat Research` **|** `Sharing Organisation : {'uuid': '56b0a0f0-b0bc-47d9-bb46-02f80ae2065a', 'name': 'EC DIGIT CSOC'}` **|** `🧱 Schema Identifier : tvm::2.1`
...
|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------|:---------------------|
| [Detect acceptance of forged web session context](../Detection%20Objectives/🎯%20Detect%20acceptance%20of%20forged%20web%20session%20context.md 'Detect cases where an application accepts caller-supplied state as an authentication or privilegecontext The detection capability focuses on evidence ...') | [Detect acceptance of forged web session context::Session variable probing across protected routes](Detect%20acceptance%20of%20forged%20web%20session%20context#session-variable-probing-across-protected-routes.md 'Alert on repeated attempts to discover accepted session variables by trying many cookie orheader names and simple values across protected routes Usefu...')<br>[Detect acceptance of forged web session context::Fabricated session value grants protected access](Detect%20acceptance%20of%20forged%20web%20session%20context#fabricated-session-value-grants-protected-access.md 'Alert when controlled validation shows a protected endpoint returning successful access after afabricated cookie, Authorization header, or request var...')<br>[Detect acceptance of forged web session context::Client-side role or identity claim changes authorisation outcome](Detect%20acceptance%20of%20forged%20web%20session%20context#client-side-role-or-identity-claim-changes-authorisation-outcome.md 'Alert when modifying a client-controlled identity, username, role, or feature flag changes theauthorisation decision for the same route and source con...') | ❌ No Detection Models  | ❌ No Detection Rules |
