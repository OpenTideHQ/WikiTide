...
🗡️ **ATT&CK Techniques** [T1053.003 : Scheduled Task/Job: Cron](https://attack.mitre.org/techniques/T1053/003 'Adversaries may abuse the codecroncode utility to perform task scheduling for initial or recurring execution of malicious codeCitation 20 macOS Common')



---

`🔑 UUID : 22c2fc38-93f5-41ee-be2d-a7737fa2b936` **|** `🏷️ Version : 1` **|** `🗓️ Creation Date : 2025-01-03` **|** `🗓️ Last Modification : 2025-01-03` **|** `Sharing Organisation : {'uuid': '56b0a0f0-b0bc-47d9-bb46-02f80ae2065a', 'name': 'EC DIGIT CSOC'}` **|** `🧱 Schema Identifier : tvm::2.0`
