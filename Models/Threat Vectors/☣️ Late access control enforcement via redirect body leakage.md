...
`🔑 UUID : 0663c192-cdeb-49a2-994c-4cc8e98f764e` **|** `🏷️ Version : 2` **|** `🗓️ Creation Date : 2026-03-30` **|** `🗓️ Last Modification : 2026-05-04` **|** `👥 Contributors : Hold Security Threat Research` **|** `Sharing Organisation : {'uuid': '56b0a0f0-b0bc-47d9-bb46-02f80ae2065a', 'name': 'EC DIGIT CSOC'}` **|** `🧱 Schema Identifier : tvm::2.1`
...
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------|:---------------------|
| [Detect protected content in abnormal redirect responses](../Detection%20Objectives/🎯%20Detect%20protected%20content%20in%20abnormal%20redirect%20responses.md 'Identify access-control defects where redirect responses carry more content than a redirectshould reasonably contain This objective is not a one-to-on...') | [Detect protected content in abnormal redirect responses::Restricted route enumeration through repeated redirects](Detect%20protected%20content%20in%20abnormal%20redirect%20responses#restricted-route-enumeration-through-repeated-redirects.md 'Alert when a source repeatedly requests distinct authenticated or role-restricted URLs andreceives 302 redirects without completing a normal authentic...')<br>[Detect protected content in abnormal redirect responses::Redirect body differs from expected unauthenticated template](Detect%20protected%20content%20in%20abnormal%20redirect%20responses#redirect-body-differs-from-expected-unauthenticated-template.md 'Use controlled synthetic checks to compare unauthenticated requests to protected routes againsta known-safe redirect template Alert when the response ...')<br>[Detect protected content in abnormal redirect responses::Large 302 response body on protected route](Detect%20protected%20content%20in%20abnormal%20redirect%20responses#large-302-response-body-on-protected-route.md 'Alert when an HTTP 302 response from an authenticated or role-restricted route has an unusuallylarge response body Required fields include request pat...') | ❌ No Detection Models  | ❌ No Detection Rules |
